...
#pragma region Windows Form Designer generated code
	void InitializeComponent(void) {
		...
		this->tabPage3->Text = L"Включение";
		// 
		// button2
		// 
		...
		this->button6->Text = L"Сортировать";
		...
		this->tabPage6->Text = L"Характеристики";
		// 
		// button1
		// 
		...
		// Column1
		// 
		this->Column1->HeaderText = L"Сравнения";
		this->Column1->Name = L"Column1";
		// 
		// Column2
		// 
		this->Column2->HeaderText = L"Перестановки";
		this->Column2->Name = L"Column2";
		this->Column2->Width = 120;
		// 
		// Column3
		// 
		this->Column3->HeaderText = L"Время";
		...
		this->Name = L"MyForm";
		this->Text = L"Алгоритмы внутренней сортировки";
...
#pragma endregion
	...
	Void button1_Click(Object^ sender, EventArgs^ e) {
		if (!table_characteristics_formed) {
			...
			dataGridView1->Rows[0]->HeaderCell->Value = "Обмен";
			dataGridView1->Rows[1]->HeaderCell->Value = "Выбор";
			dataGridView1->Rows[2]->HeaderCell->Value = "Включение";
			dataGridView1->Rows[3]->HeaderCell->Value = "Шелла";
			dataGridView1->Rows[4]->HeaderCell->Value = "Линейная";
		...
		// Число перестановок и сравнений
		...
		// Время завершения работы алгоритма
...
#pragma endregion
	...
	// ---------------------------------------------
	// Сортировка прямым включением с демонстрацией
	// ---------------------------------------------
	...
	// ---------------------------------------------
	// Сортировка прямым выбором с демонстрацией
	// ---------------------------------------------
	...
	// ---------------------------------------------
	// Сортировка прямым обменом с демонстрацией
	// ---------------------------------------------
	...
	// ---------------------------------------------
	// Сортировка прямым включением с замером характеристик
	...
	// Сортировка прямым включением с выводом массива
	...
	// Сортировка прямым выбором с замером характеристик
	static void forward_selection(int* num, int size, int& permutations, int& comparisons) {
		int min, temp; // для поиска минимального элемента и для обмена
		for (int i = 0; i < size - 1; i++) {
			min = i; // Запоминаем индекс текущего элемента
			// Поиск минимального элемента, чтобы поместить на место i-ого
	...
	// Сортировка прямым выбором с выводом массива
	...
	// Сортировка прямым обменом (метод "пузырька") с замером характеристик
	...
	// Сортировка прямым обменом (метод "пузырька") с выводом массива
	...
	// Cортировка Шелла с выводом массива
	...
	// Линейная сортировка с замером характеристик
	static void linear(int* num, int size) {
		...
		for (int i = 0; i < size; i++)
			help_arr[num[i]]++;
		int j = 0;
		// Проход по всему вспомогательныму массиву
		for (int i = 0; i < size; i++)
			// Запись в массив k одинаковых i-ых элементов из вспомогательного массива
			for (int k = 0; k < help_arr[i]; ++k)
				num[j++] = i;
		delete[] help_arr;
	}
	// Линейная сортировка с выводом массива
