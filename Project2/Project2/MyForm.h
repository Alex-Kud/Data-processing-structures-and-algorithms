...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button2->Font = (gcnew System::Drawing::Font(L"Tahoma", 9, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->button2->Location = System::Drawing::Point(591, 420);
			this->button2->Name = L"button2";
			this->button2->Size = System::Drawing::Size(173, 28);
			...
			this->button1->Font = (gcnew System::Drawing::Font(L"Tahoma", 9, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->button1->Location = System::Drawing::Point(110, 420);
			...
			// numericUpDown1
			// 
			this->numericUpDown1->Location = System::Drawing::Point(110, 101);
			this->numericUpDown1->Name = L"numericUpDown1";
			this->numericUpDown1->Size = System::Drawing::Size(262, 27);
			this->numericUpDown1->TabIndex = 30;
			this->numericUpDown1->Maximum = 1000000;
			// 
			// numericUpDown2
			// 
			this->numericUpDown2->Location = System::Drawing::Point(591, 101);
			this->numericUpDown2->Name = L"numericUpDown2";
			this->numericUpDown2->Size = System::Drawing::Size(262, 27);
...
#pragma endregion
	...
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
			...
			for (int i = 0; i < N - 1; ++i) {
				if (key == arr[i]) { // заканчивается удачно
					found = i;
					break;
				}
			}
			...
			textBox3->Text = Convert::ToString(found);
			...
			if (found == -1)
				...
				textBox5->Text = Convert::ToString(found);
			textBox4->Text = Convert::ToString(time_took_optimal.count() * 10000);
	}
	private: System::Void button2_Click(System::Object^ sender, System::EventArgs^ e) {
			int key = Convert::ToInt32(numericUpDown2->Value); // Считываем ключ
			int found = -1;
			...
			if (found == -1)
				...
				textBox8->Text = Convert::ToString(found);
			textBox10->Text = "No";
			// Алгоритм оптимального поиска как в упорядоченном
			auto begin_ordered = std::chrono::high_resolution_clock::now();
			arr2[N-1] = key + 1; // барьер
			int k = 0;
			while (key > arr2[k])
				++k;
			if (key == arr2[k]) // поиск удачен
				found = k;
			if (found == -1)
				textBox10->Text = "No";
			else
				textBox10->Text = Convert::ToString(found);
